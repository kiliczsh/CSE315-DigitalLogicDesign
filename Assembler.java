    ...
    switch (opcode){
        ...
        case "LD":
            ...
            toFile=toFile.concat(destinationRegister);
            	...
            	if(addrld<0) {
            		oneOrZero="1";
            		addr=""+""+Integer.parseInt(Integer.toBinaryString((128-Math.abs(addrld))));
            	}else {
            		oneOrZero="0";
        ...
        case "ST":
            ...
            toFile=toFile.concat(sourceRegister);
            	...
            	if(addrst<0) {
            		oneOrZero="1";
            		addr=""+""+Integer.parseInt(Integer.toBinaryString((128-Math.abs(addrst))));
            	}else {
            		oneOrZero="0";
        ...
        case "JUMP":
			...
			if(addrjump<0) {
				oneOrZero="1";
				addr=""+""+Integer.parseInt(Integer.toBinaryString((128-Math.abs(addrjump))));
        	}else {
        		oneOrZero="0";
        ...
        case "BEQ":
        	...
        	int addrbeq=Integer.parseInt(seperateRegisterAdress(elementArray[2]));
    			if(addrbeq<0) {
    				oneOrZero="1";
    				addr=""+""+Integer.parseInt(Integer.toBinaryString((128-Math.abs(addrbeq))));
            	}else {
            		oneOrZero="0";
    	...
    	int addrblt=Integer.parseInt(seperateRegisterAdress(elementArray[2]));
			if(addrblt<0) {
				oneOrZero="1";
				addr=""+""+Integer.parseInt(Integer.toBinaryString((128-Math.abs(addrblt))));
        	}else {
        		oneOrZero="0";
        ...
        toFile=toFile.concat(operation2);
        	...
        	if(addrbgt<0) {
        		oneOrZero="1";
        		addr=""+""+Integer.parseInt(Integer.toBinaryString((128-Math.abs(addrbgt))));
        	}else {
        		oneOrZero="0";
    	...
    	int addrble=Integer.parseInt(seperateRegisterAdress(elementArray[2]));
    		if(addrble<0) {
    			oneOrZero="1";
    			addr=""+""+Integer.parseInt(Integer.toBinaryString((128-Math.abs(addrble))));
        	}else {
        		oneOrZero="0";
    	...
    	int addrbge=Integer.parseInt(seperateRegisterAdress(elementArray[2]));
			if(addrbge<0) {
				oneOrZero="1";
				addr=""+""+Integer.parseInt(Integer.toBinaryString((128-Math.abs(addrbge))));
			}else {
    			oneOrZero="0";
